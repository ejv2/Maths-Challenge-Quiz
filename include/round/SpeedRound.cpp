...
void SpeedRound::runCountdown()
{
    ...
    for (int i = 5; i > 0; i--)
    {
        ...
        this->currentCountdownText = "Round begins in: " + std::to_string(i) + "s ";
...
{
    return "You will be asked regular multiplication questions, but the speed at which you answer will be measured.\nPoints will be awarded for fast answers, but slow answers may result in deduction.";
}
